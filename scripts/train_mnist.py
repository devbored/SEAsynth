...
def train():
    ...
    model = keras.Sequential([
        ...
        keras.layers.Conv2D(
            12, kernel_size=(3,3), strides=(1,1), activation='relu', input_shape=(28,28,1), use_bias=False
        ),
    ...
    print("\n[Info]: Converting trained weight data to raw hexadecimal float32 values...")
